  ...
  return (
    <>
      <tr>
        ...
        <td>
          ...
          <Button
            ...
            className="me-2"
            onClick={() => {
              const type = window.confirm("Force reboot (HARD) ?")
                ? "HARD"
                : "SOFT";
      ...
      {currentStatus === "VERIFY_RESIZE" && (
        <Modal
          show={showConfirmResize}
          onHide={() => setShowConfirmResize(false)}
        >
          <Modal.Header closeButton>
          ...
          <Modal.Body>
            <p>
              The resize is pending confirmation. What would you like to do?
            </p>
          </Modal.Body>
          <Modal.Footer>
            <Button
              ...
              onClick={async () => {
                await api.post(
                  `${API_BASE}/revert-resize/${resizeStatus.vmId}`
                );
            ...
            <Button
              ...
              onClick={async () => {
                await api.post(
                  `${API_BASE}/confirm-resize/${resizeStatus.vmId}`
                );
                setShowConfirmResize(false);
              }}
            >
